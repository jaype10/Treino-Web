...
--
-- Host: localhost
-- Tempo de geração: 20/10/2025 às 14:29
...
(10, 'João', 88, 'Música', 'non@facilisisvitae.edu', 'PB'),
...
(44, 'João', 82, 'Música', 'nec.eleifend.non@sapien.ca', 'RR'),
(45, 'João', 98, 'Esporte', 'placerat@ametorci.ca', 'PR'),
...
(63, 'João', 89, 'Informática', 'mauris.aliquam.eu@Proindolor.net', 'PA'),
...
(72, 'João', 82, 'Jogos', 'dui@interdumligula.ca', 'AP'),
...
(86, 'João', 92, 'Música', 'tortor.at.risus@ac.edu', 'DF'),
...
(98, 'João', 83, 'Música', 'Class.aptent@et.co.uk', 'AM'),
(99, 'João', 95, 'Jogos', 'Donec.porttitor.tellus@nonfeugiat.co.uk', 'DF'),
